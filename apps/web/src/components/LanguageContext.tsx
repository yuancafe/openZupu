...
const translations = {
  zh: {
    ...
    updatedAt: "更新时间",
    landingTitle: "数字化族谱文献库",
    landingDesc: "管理您的家族世系，记录 Y-DNA/mtDNA 基因单倍群，运行联邦对等网寻根匹配。",
    exploreBtn: "进入探索",
    cancelBtn: "取消",
    createBtn: "创建",
    createNewRepo: "🏮 新增数字化族谱库",
    createNewRepoDesc: "提供资料信息以初始化一个独立的家谱分支分支。",
    updated: "更新时间",
    noDescription: "暂无描述。可在项目详情页中进行编纂录入。",
    newPedigreeBook: "＋ 录入新谱书",
    cancelBtnX: "✕ 取消",
    ...
    membersTab: "项目成员",
    dataToolsTab: "数据工具",
    generationPoemTab: "字辈昭穆",
    migrationMapTab: "迁徙地图",
    addPerson: "新增人物",
    savePerson: "保存人物信息",
    surname: "姓",
    givenName: "名",
  ...
  en: {
    ...
    landingTitle: "Digital Pedigree Repositories",
    landingDesc: "Manage your family lineage, track Y-DNA/mtDNA markers, and run federated matching with other clan databases.",
    exploreBtn: "Explore",
    cancelBtn: "Cancel",
    createBtn: "Create",
    createNewRepo: "🏮 Create New Pedigree Repository",
    createNewRepoDesc: "Provide details to initialize a separate database branch.",
    updated: "Updated",
    noDescription: "No description compiled yet. Enter edit mode inside the project view to write origins.",
    newPedigreeBook: "＋ New Pedigree Book",
    cancelBtnX: "✕ Cancel",
    ...
    generationPoemTab: "Generation Poem",
    migrationMapTab: "Migration Map",
